...
static const unsigned char* const order1[] = {P0,P4,P4,P8,P11};
static const unsigned char* const order2[] = {P1,P5,P5,P9,P12};
static const unsigned char* const order3[] = {P2,P6,P6,P10,P6};
...
const hUGESong_t bosstheme = {5, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
