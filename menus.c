...
{0x13, 0x18, 0x1E, 0x0F, 0x1C, 0x13, 0x19, 0x1C}, {0x0F, 0x18, 0x0F, 0x1C, 0x11, 0x23, 0x00, 0x0D, 0x19, 0x1C, 0x0F}};
const UINT8 stnamelengths[] = {14, 12, 13, 10, 12, 8, 11};
...
{28, 32, 13, 36}, {0x20, 0x14, 0x0E, 0x23}, {31, 28, 30, 18}};
