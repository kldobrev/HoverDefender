...
F:\Game_Boy_Dev_Tools\gbdk\bin\lcc -IF:\hUGETracker_1_0b9\hUGEDriver\include -Wa-l -Wl-m -Wl-j -Wl-yt1 -Wl-yo4 -o hoverdefender.gb main.c hUGEDriver.obj.o ost\*.c bank1.o bank2.o